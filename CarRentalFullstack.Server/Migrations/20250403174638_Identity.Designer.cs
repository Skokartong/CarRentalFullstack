...
namespace CarRentalFullstack.Server.Migrations
{
    ...
    [Migration("20250403174638_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalFullstack.Server.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CarRentalFullstack.Models.Rental", b =>
                {
                    ...
                    b.HasOne("CarRentalFullstack.Server.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarRentalFullstack.Server.Models.User", null)
                        .WithMany()
